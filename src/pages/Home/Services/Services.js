                        ...
                        <div className="md:grid lg:grid-cols-3">
                            <div className="bg-gradient-to-r from-slate-100 to-slate-200 w-full h-auto py-20 lg:my-8 rounded-lg flex justify-center" >
                                <ul>
                                    ...
                                    <button className="bg-gradient-to-r from-blue-300 to-indigo-600 mt-10 py-3 px-6 rounded-lg ml-2 text-1xl font-semibold text-slate-50">Get Started</button>
                                </ul>
                            </div>
                        ...
                        <div className="md:grid lg:grid-cols-3">
                            <div className="bg-gradient-to-r from-amber-50 to-amber-100 w-full h-auto py-20 lg:my-8 rounded-lg flex justify-center">
                                <ul>
                                    ...
                                    <li className="text-center text-1xl font-semibold text-gray-600 pt-4"> Link Building</li>
                                    <li className="text-center text-1xl font-semibold text-gray-600 pt-4"> Site Migration</li>
                                    <button className="bg-gradient-to-r from-orange-300 to-orange-600 mt-10 py-3 px-6 rounded-lg ml-2 text-1xl font-semibold text-slate-50">Get Started</button>
                                </ul>
                            </div>
