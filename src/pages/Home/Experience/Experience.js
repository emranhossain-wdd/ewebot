    ...
    return (
        <div className='experience flex w-11/12 mx-auto relative py-24 mt-12 gap-5'>
            ...
            <div className="experience-right-details w-3/6">
                ...
                <button className='ml-4 border border-[#4f46e5] hover:bg-[#4f46e5] hover:text-[#fff] rounded px-5  py-3 font-semibold transition duration-700'>Discover More</button>
            </div>
        </div>
    );
};
