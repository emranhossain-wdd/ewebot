...
import AOS from 'aos';
import img1 from '../../../images/triangle_blue.png';
import img2 from '../../../images/triangle_orange.png';
    ...
    return (
        <div className='banner w-11/12 mx-auto flex justify-center pb-4 mt-8'>
            ...
            <div className="banner-text grid items-center content-center">
                <div className="heading-text mb-8 relative">
                    ...
                    <div className="absolute top-0 -right-36 animate-bounce duration-1000">
                        <img src={img1} alt="" />
                    </div>
                    <div className="absolute top-44 -right-40 animate-bounce duration-400">
                        <img src={img2} alt="" />
                    </div>
                </div>
