...
const AppointmentBtn = ({ date, ProfessionalsName, appointmentTime, setDate }) => {
    ...
    return (
        <div>
            <Container>
                <Grid container spacing={2}>
                    ...
                    <Grid>
                        <Typography
                            sx={{ py: 4 }}
                            style={{ color: "#1976d2", fontWeight: "400", fontSize: "30px" }}
                        >
                        ...
                        <Button
                            ...
                            sx={{ mt: 2 }}
                            style={{ backgroundColor: "#1976d2", padding: "8px 12px" }}
                            variant="contained"
                        >
                            BOOK APPOINTMENT
                        </Button>
            ...
            {/* <Container>
                <Typography
                    sx={{ py: 4 }}
                    style={{ color: "#5CE7ED", fontWeight: "400", fontSize: "30px" }}
                >
                    AvailableAppointment on {date.toDateString()}
                </Typography>
                {bookingSuccess && <Alert severity="success">appointment booked successfully!</Alert>}
